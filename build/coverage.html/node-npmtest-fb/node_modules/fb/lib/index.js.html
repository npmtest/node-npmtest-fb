...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-fb/node_modules/fb/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-fb/node_modules/fb/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-fb/node_modules/fb/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof FB[_key] === 'function') {
			exports[_key] = FB[_key].bind(FB);
		} else {
<span class="cstat-no" title="statement not covered" >			exports[_key] = FB[_key];</span>
		}
	}
} catch (err) {
